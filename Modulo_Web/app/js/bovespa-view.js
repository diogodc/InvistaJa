                    ...
                    return bovespa.template([
                        {
                            ...
                            view: {
                                self: '.s-body-content',
                                render: function (model) {
                                    bovespa.config.chart.themes().Liquidity();
                                ...
                                'render-before': function (view, model) {
                                    ...
                                    bovespa.object.extend(model, this.model_change("ga", model, {
                                        preAnalysis: function (_analysis) {
                                            ...
                                            if (_analysis.max.year < _analysis.min.year) {
                                                _situation = " <p style='display: block;'>A situação piorou " + _analysis.min.year + "/" + _analysis.max.year + ".</p> A Empresa não conseguiu obter um retorno superior ao ano de " + _analysis.max.year;
                                            } else {
                                                _situation = " <p style='display: block;'>A situação melhorou " + _analysis.min.year + "/" + _analysis.max.year + ". </p> ";
                                                _situation += "A Empresa conseguiu obter um retorno superior ao investimento feito no Ativo.";
                                            }
                                    ...
                                    bovespa.object.extend(model, this.model_change("ml", model, {
                                        preAnalysis: function (_analysis) {
                                            var _situation;
                                            if (_analysis.max.year < _analysis.min.year) {
                                                _situation = " <p style='display: block;'>A situação piorou " + _analysis.min.year + "/" + _analysis.max.year + ".</p> A empresa apresentou um Retorno sobre as vendas inferior ao ano de " + _analysis.max.year;
                                            } else {
                                                _situation = " <p style='display: block;'>A situação melhorou " + _analysis.min.year + "/" + _analysis.max.year + ". </p> ";
                                                _situation += "<p style='display: block;'>A empresa apresentou um Retorno sobre as vendas em " + _analysis.max.year + ", passando de " + _analysis.min.value + " para " + _analysis.max.value + ". </p> A lucratividade sobre as vendas foi " + Number(_analysis.min.value / _analysis.max.value).formatMoney(2, ',', '.') + '% superior.';
                                            }
                                            return _situation;
                                        }
                                    }));
                                    bovespa.object.extend(model, this.model_change("ra", model, {
                                        preAnalysis: function (_analysis) {
                                            var _situation;
                                            if (_analysis.max.year < _analysis.min.year) {
                                                _situation = " <p style='display: block;'>A situação piorou " + _analysis.min.year + "/" + _analysis.max.year + ".</p> A Empresa conseguiu obter um retorno superior ao investimento feito no Ativo.";
                                            } else {
                                                _situation = " <p style='display: block;'>A situação melhorou " + _analysis.min.year + "/" + _analysis.max.year + ". </p> ";
                                    ...
                                    bovespa.object.extend(model, this.model_change("rpl", model, {
                                        preAnalysis: function (_analysis) {
                                            ...
                                            if (_analysis.max.year < _analysis.min.year) {
                                                ...
                                                _situation = " <p style='display: block;'>A situação melhorou " + _analysis.min.year + "/" + _analysis.max.year + ". </p> ";
                                                _situation += "A empresa apresentou um Retorno sobre as vendas em " + _analysis.max.year + ", passando de " + _analysis.min.value + " para " + _analysis.max.value + ". Ou seja, a lucratividade sobre as vendas foi de ." + Number(_analysis.min.value / _analysis.max.value).formatMoney(2, ',', '.');
                                            }
                                            return _situation;
                                        }
                                    }));
